            ...
            this.fields2 = {
                Events: [
                    {
                        ...
                        cp: (v: boolean) =>
                            this.config.modifyConfiguration((c) => (c.useFotlArmor = v)),
                ...
                "Armor selection": [
                    ...
                    },
                    {
                        ...
                        cp: (v: boolean) =>
                            this.config.modifyConfiguration((c) => (c.ignoreSunsetArmor = v)),
                ...
                Masterwork: [
                    {
                        ...
                        cp: (v: boolean) =>
                            this.config.modifyConfiguration(
                                (c) => (c.assumeLegendariesMasterworked = v)
                            ),
                    ...
                    },
                    {
                        ...
                        cp: (v: boolean) =>
                            this.config.modifyConfiguration(
                                (c) => (c.assumeExoticsMasterworked = v)
                            ),
                    ...
                    },
                    {
                        ...
                        cp: (v: boolean) =>
                            this.config.modifyConfiguration(
                                (c) => (c.assumeClassItemMasterworked = v)
                            ),
                    ...
                    },
                    {
                        ...
                        cp: (v: boolean) =>
                            this.config.modifyConfiguration(
                                (c) => (c.onlyUseMasterworkedItems = v)
                            ),
                ...
                "Wasted Stats": [
                    ...
                    },
                    {
                        ...
                        cp: (v: boolean) =>
                            this.config.modifyConfiguration(
                                (c) => (c.onlyShowResultsWithNoWastedStats = v)
                            ),
                        value:
                        ...
                        disabled:
                            !c.tryLimitWastedStats || !environment.featureFlags.enableZeroWaste,
                        impactsResultCount: true,
                ...
                "Data-Science": [
                    ...
                    },
                    {
                        ...
                        cp: (v: boolean) =>
                            this.config.modifyConfiguration(
                                (c) => (c.assumeEveryLegendaryIsArtifice = v)
                            ),
